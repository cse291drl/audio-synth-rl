...
class SynthParamsLoss:
    ...
    def __init__(self, idx_helper, normalize_losses: bool, categorical_loss_factor=0.2,
...
class QuantizedNumericalParamsLoss:
    ...
    """
    def __init__(self, idx_helper, numerical_loss=nn.MSELoss(),
...
class CategoricalParamsAccuracy:
    ...
    def __init__(self, idx_helper, reduce=True, percentage_output=True,
                 limited_vst_params_indexes: Optional[Sequence] = None):
        """
...
class FlowParamsLoss:
    ...
    """
    def __init__(self, idx_helper, latent_flow_inverse_function, reg_flow_inverse_function):
        self.idx_helper = idx_helper
    ...
    def __call__(self, z_0_mu_logvar, v_target):
        ...
        z_0_log_prob = gaussian_log_probability(z_0, z_0_mu_logvar[:, 0, :], z_0_mu_logvar[:, 1, :])
