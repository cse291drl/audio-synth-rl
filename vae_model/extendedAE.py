...
class ExtendedAE(nn.Module):
    ...
    def __init__(self, ae_model, reg_model, idx_helper, dropout_p=0.0):
        super().__init__()
        ...
        if isinstance(self.reg_model, vae_model.regression.FlowRegression):
            self._is_flow_based_regression = True
        elif isinstance(self.reg_model, vae_model.regression.MLPRegression):
